  ...
  describe '#get' do
    context 'with valid credentials' do
      ...
      context 'and an invalid endpoint' do
        it 'raises a CloudParty::ConnectionError' do
          expect { connection.get('invalid') }.to raise_error(CloudParty::ConnectionError)
        end
      end
    end
    ...
    context 'with invalid credentials' do
      ...
      it 'raises a CloudParty::ConnectionError' do
        expect { connection.get('user') }.to raise_error(CloudParty::ConnectionError)
      end
    end
  end
end
